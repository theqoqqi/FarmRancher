...
public class SimpleIngredients {
	...
	public static final Map<Item, Double> PRICES = new HashMap<>() {
		{
			put(Items.WHEAT, per64Items(2.5));
			put(Items.CARROT, per64Items(4));
			put(Items.POTATO, per64Items(4.5));
			put(Items.BEETROOT, per64Items(5));
			put(Items.PUMPKIN, per64Items(8));
			put(ModItems.PUMPKIN_SLICE.get(), get(Items.PUMPKIN) / 4);
			put(Items.MELON, per64Items(8));
			put(Items.MELON_SLICE, get(Items.MELON) / 9);
			put(ModItems.CABBAGE.get(), per64Items(6));
			put(ModItems.CABBAGE_LEAF.get(), get(ModItems.CABBAGE.get()) / 2);
			put(ModItems.TOMATO.get(), per64Items(3.5));
			put(ModItems.ONION.get(), per64Items(4));
			put(ModItems.RICE.get(), per64Items(4.5));

			put(Items.RED_MUSHROOM, per64Items(8));
			put(Items.BROWN_MUSHROOM, per64Items(5));
			put(Items.KELP, per64Items(1.5));
			put(Items.APPLE, per64Items(5));
			put(Items.SUGAR, per64Items(1.5));
			put(Items.EGG, per16Items(1.5));
